  ...
  fields: [
    ...
    // -------------------------------------------------------------
    {
      ...
      fields: [
        ...
        { name: 'flor_tamano', title: 'Tamaño flor (cm)', type: 'number' },
        ...
        { name: 'fruto_tamano', title: 'Tamaño fruto (cm)', type: 'number' },
        ...
        { name: 'semilla_tamano', title: 'Tamaño semilla (mm/cm)', type: 'number' },
