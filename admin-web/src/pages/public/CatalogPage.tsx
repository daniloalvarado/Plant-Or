      ...
      {activePlant && (
        ...
        >
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            <span className="px-3 py-1 bg-[#229c22] text-white border border-transparent text-[10px] lg:text-xs font-bold rounded-full uppercase tracking-wider mb-2 lg:mb-3 inline-block transition-colors duration-300">
      ...
      >
        ...
        <div className="w-full md:w-1/2 h-[40vh] md:h-full bg-black relative group flex-shrink-0">
          ...
          <div className="absolute bottom-4 left-6 right-6 z-10 lg:hidden">
            <span className="px-2.5 py-1 bg-[#229c22] text-white border border-transparent text-xs font-bold rounded-md uppercase tracking-wider mb-2 inline-block shadow-lg">
        ...
        <div className="w-full md:w-1/2 flex-1 overflow-y-auto p-6 md:p-8 space-y-8 custom-scrollbar relative bg-card">
          ...
          <div className="hidden md:block border-b border-border pb-4">
            <span className="px-2.5 py-1 bg-[#229c22] text-white border border-transparent text-xs font-bold rounded-md uppercase tracking-wider mb-3 inline-block shadow-sm">
              {currentPlant.habito || 'Planta'}
            </span>
