      ...
      {activePlant && (
        ...
        >
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            <span className="text-brand-green border-b-2 border-brand-green pb-0.5 text-[10px] lg:text-xs font-bold uppercase tracking-wider mb-2 lg:mb-3 inline-block transition-colors duration-300">
