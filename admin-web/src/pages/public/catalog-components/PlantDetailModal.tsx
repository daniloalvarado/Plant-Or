      ...
      >
        ...
        <div className="w-full md:w-1/2 flex-1 overflow-y-auto p-6 md:p-8 space-y-8 custom-scrollbar relative bg-card">
          ...
          <div className="hidden md:block border-b border-border pb-4">
              <span className="text-gradient-green border-b-2 border-custom-green pb-0.5 text-xs font-bold uppercase tracking-wider mb-3 inline-block">
              {currentPlant.habito || 'Planta'}
            </span>
          ...
          <div className="space-y-3">
            <h3 className="text-sm font-bold text-gradient-green uppercase tracking-wider border-b border-border pb-2">
            ...
            {currentPlant.latitud && currentPlant.longitud && (
              <button
                ...
                className="flex items-center gap-1.5 mt-3 text-sm font-bold text-gradient-green hover:underline cursor-pointer"
              >
