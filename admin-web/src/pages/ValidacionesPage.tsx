    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4 cascade-container">
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          <div className="relative flex-1 w-full sm:max-w-md cascade-item delay-1">
          ...
          <div className="flex gap-2">
            {!filtroEstado && (role === 'admin' || role === 'profesor_validador') && (
              <>
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-secondary text-foreground rounded-lg hover:bg-accent transition-colors text-sm cursor-pointer cascade-item delay-2"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-secondary text-foreground rounded-lg hover:bg-accent transition-colors text-sm cursor-pointer cascade-item delay-3"
                >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-secondary border border-border rounded-lg text-sm text-foreground hover:bg-accent transition-colors cursor-pointer cascade-item delay-4"
            >
